...
public let logDateFormatter: ISO8601DateFormatter = {
...
public func getAudioProperty<T>(_ objectID: AudioObjectID, selector: AudioObjectPropertySelector,
...
public func getStringProperty(_ objectID: AudioObjectID, selector: AudioObjectPropertySelector) -> String? {
...
public func getAllAudioDeviceIDs() -> [AudioDeviceID] {
...
public func transportTypeName(_ type: UInt32) -> String {
    switch type {
...
public func describeDevice(_ deviceID: AudioDeviceID) -> String {
...
public func logAllDevices(prefix: String) {
...
public let pidPath = "/tmp/mic-warm.pid"

public func writePID() {
    do {
...
public func cleanupPID() {
    unlink(pidPath)
}

public func killStalePID() {
...
public class MicKeeper: NSObject, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    // Explicit user-initiated stop (Bluetooth-safe, same teardown pattern as device switch).
    public func stop() {
        debounceWork?.cancel()
        debounceWork = nil
        stopHeartbeat()
